...
import com.nokia.uni.sri.domain.ImpactObject;
...
public class HackController {
	...
	public void createDevice(@RequestBody ImpactObject impactObject) {

		System.out.println("===================================="+impactObject);
		if(impactObject.getRegistrations().length>0) {
			//Do Nothing
		}
		else if(impactObject.getReports().length>0) {
			hackService.updateDevice(impactObject.getReports()[0]);
		}
	}
	...
	private void doCurlRegister() {
		try {
			...
			String data =  "{\"format\":\"json\",\"pattern\":\"#\",\"headers\": {\"authorization\":\"Basic dWF0YWRlcDpBc2RmMSM=\"}, \"url\":\"http://10.58.127.24:8080/m2m/impact/callback\"}";
